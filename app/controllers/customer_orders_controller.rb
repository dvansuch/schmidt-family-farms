class CustomerOrdersController < ApplicationController
  ...
  private
    ...
    def customer_order_params
      params.require(:customer_order).permit(:first_name, :last_name, :email, :phone, :address, :city, :state, :zip, :whole_beef, :integer, :half_beef, :qtr_beef, :bbq_hog, :half_hog, :whole_hog, :chickens, :lamb, :bbq_pit, :comments)
    end
end
