...
order1 = Order.create! whole_beef: nil, half_beef: nil, qtr_beef: 1, bbq_hog: nil, half_hog: 1, whole_hog: nil, chickens: 5, lamb: nil, bbq_pit: false, comments: "Do you deliver to Colorado springs?"
